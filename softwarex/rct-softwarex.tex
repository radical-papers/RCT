...
% including the leadership-class machines managed by ORNL, NCSA and TACC. 


% RCT allow rapid development of applications for software engineering, chemical
...
% \amnote{what is an 'instruction of a program'?}\mtnote{Not sure. Changed,
% alongside the rest of the paragraph. Any better?}
...
and ExecManager can fail without loss of information about the execution.% \mtnote{Vivek to expand upon the dequeuer.}
...
Turilli is the lead architect of EnTK, co-architect of RADICAL-Pilot and
wrote the paper.
