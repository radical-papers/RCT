...
functions, methods, threads or subprocesses. \amnote{Things that \I{"run as
self-contained executables"} are usually processes.}\mtnote{better?}
...
\amnote{"represents an executable program"?}\mtnote{Done.}
...
RP?  It's also (rightly) not mentioned in the text.}\mtnote{Done.}
