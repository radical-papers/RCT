...
aggregated capabilities. \jhanote{I think the classification should be moved upstream and promoted. It should replace a lot of the current text for RP and EnTK (~3 pages), which exists and should be referenced, not replicated}

\jhanote{Illustrative examples should illustrate not science impact but }
...
\jhanote{I would organize impact around the three classes used in illustrative examples}
