...
Fig.~\ref{fig:arch-rp} shows the subsystems and components of
RP () alongside the control and information flow among them. RP has four subsystems: Client, Agent and MongoDB\@. Client has two components  

\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figures/arch_rp.pdf}
    \caption{Caption.}\label{fig:arch-rp}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{figures/arch_entk.pdf}
    \caption{Caption.\label{fig:arch_entk}}
\end{figure}
