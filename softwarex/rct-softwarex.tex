...
supports \mtnote{add number} use cases, spanning functional and scientific
...
Between \mtnote{add year} and \mtnote{add year}, RADICAL-SAGA was used to
...
including DECIDE and neuGRID \mtnote{others?}, to study the early diagnosis
...
Europe, for a total of \mtnote{insert number} users. Since its first release
in 2013, RP has supported a total of \mtnote{insert number} projects and
around 100 active users. Of these, \mtnote{insert number} projects used RP
